...
[![Go Report Card](https://goreportcard.com/badge/github.com/dkischenko/gomarkdoc)](https://goreportcard.com/report/github.com/dkischenko/gomarkdoc)
[![GitHub Actions](https://github.com/dkischenko/gomarkdoc/workflows/Test/badge.svg)](https://github.com/dkischenko/gomarkdoc/actions?query=workflow%3ATest+branch%3Amaster)
[![Go Reference](https://pkg.go.dev/badge/github.com/dkischenko/gomarkdoc.svg)](https://pkg.go.dev/github.com/dkischenko/gomarkdoc)
[![codecov](https://codecov.io/gh/dkischenko/gomarkdoc/branch/master/graph/badge.svg?token=171XNH5XLT)](https://codecov.io/gh/dkischenko/gomarkdoc)

# gomarkdoc

```go
import "github.com/dkischenko/gomarkdoc"
```
...
```
go install github.com/dkischenko/gomarkdoc/cmd/gomarkdoc@latest
```

For older versions of go, you can install using the following method instead:

```
GO111MODULE=on go get -u github.com/dkischenko/gomarkdoc/cmd/gomarkdoc
```
...
You can see all of the data available to the output template in the PackageSpec struct in the github.com/dkischenko/gomarkdoc/cmd/gomarkdoc package.
...
```
gomarkdoc --repository.url "https://github.com/dkischenko/gomarkdoc" --repository.default-branch master --repository.path / -o README.md .
```
...
<a name="Renderer"></a>
## type [Renderer](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L16-L20>)
...
### func [NewRenderer](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L31>)
...
### func \(\*Renderer\) [Example](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L184>)
...
### func \(\*Renderer\) [File](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L156>)
...
### func \(\*Renderer\) [Func](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L170>)
...
### func \(\*Renderer\) [Package](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L163>)
...
### func \(\*Renderer\) [Type](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L177>)
...
## type [RendererOption](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L23>)
...
<a name="WithFormat"></a>
### func [WithFormat](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L146>)
...
### func [WithTemplateOverride](<https://github.com/dkischenko/gomarkdoc/blob/master/renderer.go#L132>)
